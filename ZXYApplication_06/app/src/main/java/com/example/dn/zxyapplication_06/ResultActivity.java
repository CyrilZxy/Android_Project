...
public class ResultActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private void initWidget(){
        button=(Button) findViewById(R.id.main_but);                    //强制转换
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                switch (i){
                    ...
                    case 1: intent = new Intent(Intent.ACTION_SENDTO);
                        ...
                        startActivity(intent);
                        break;
                    case 2: intent = new Intent(ResultActivity.this,AddData.class);
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.main_but:
                ...
                Intent intent = new Intent(ResultActivity.this,AddData.class);
